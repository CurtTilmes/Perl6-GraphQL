...
unit module GraphQL::GraphiQL;

# This HTML file from Github graphql/graphiql repository
# https://github.com/graphql/graphiql/blob/master/example/index.html
# Redistributed base don the LICENSE file in that repository.
# I changed some links to get graphiql.css and graphiql.js from
# Cloudflare CDN.
